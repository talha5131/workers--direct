            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="best">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 padding-top-20">
                            <div class="about_image_wrapper"> <img class="img-responsive" src="images/content/about-workers-direct-1.jpg" alt="about-img"> </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 padding-top-20">
                            <div class="about_image_wrapper"> <img class="img-responsive" src="images/content/about-workers-direct-2.jpg" alt="about-img"> </div>
                        </div>
                    </div> <!-- Tab 2    -->
                    <div role="tabpanel" class="tab-pane fade" id="hot">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 padding-top-20">
                            <div class="about_image_wrapper"> <img class="img-responsive" src="images/content/employer-workers-direct.png" alt="about-img"> </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="about_text_wrapper abt_2_para">
                                <div class="section_heading section_2_heading">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="trand">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 padding-top-20">
                            <div class="about_image_wrapper"> <img class="img-responsive" src="images/content/job-seeker-workers-direct.jpg" alt="about-img"> </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="about_text_wrapper abt_2_para">
                                <div class="section_heading section_2_heading">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="ideal">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 padding-top-20">
                            <div class="about_image_wrapper"> <img class="img-responsive" src="images/content/best-temping-agency-workers-direct.jpg" alt="about-img"> </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="about_text_wrapper abt_2_para">
...
</div><!-- jp best deal Wrapper Start -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="jp_best_deal_heading_wrapper">
                    <div class="jp_best_deal_heading">
                        <h4>Industries & Sectors We Cover as Leading Recruitment Agency</h4> <br>
                    </div>
                </div>
            </div>
            <div class="margin-top-100">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                <div class="grid-box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/hospitality-&-catering-workers-direct.jpg" alt="Admin">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/admin-&-reception-workers-direct.jpg" alt="Admin">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/school-&-academics-workers-direct.jpg" alt="Admin">
                                        <div class="middle"> <i class="fa fa-plus-circle"></i> </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/health-&-social-care-workers-direct.jpg" alt="Admin">
                                        <div class="middle"> <i class="green fa fa-plus-circle"></i> </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/trade-&-construction-workers-direct.jpg" alt="Admin">
                                        <div class="middle"> <i class="green fa fa-plus-circle"></i> </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/warehouse-&-logistics-workers-direct.jpg" alt="Admin">
                                        <div class="middle"> <i class="fa fa-plus-circle"></i> </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/it-&-technology-workers-direct.jpg" alt="Admin">
                                        <div class="middle"> <i class="fa fa-plus-circle"></i> </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center"> <a href="#">
                            <div class="box">
                                ...
                                <div class="grid-box-1">
                                    <div class="img-section"> <img src="images/content/virtual-&-remote-employees-workers-direct.jpg" alt="Admin">
                                        <div class="middle"> <i class="fa fa-plus-circle"></i> </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <div class="step-1 margin-top-20">
                    ...
                    <div class="jp_best_deal_cont_sec margin-top-15">
                        <h4><a href="register.php">Register / Login</a></h4>
                ...
                <div class="step-1 margin-top-20">
                    ...
                    <div class="jp_best_deal_cont_sec margin-top-15">
                        <h4><a href="cv-registration.php">CV Registration</a></h4>
                ...
                <div class="step-1 margin-top-20">
                    ...
                    <div class="jp_best_deal_cont_sec margin-top-15">
                        <h4><a href="submit-a-job.php">Submit a Job / Get Hired</a></h4>
...
<!-- jp tittle slider Wrapper Start			<div class="jp_tittle_slider_main_wrapper" style="float:left; width:100%; margin-top:30px;">				<div class="container">					<div class="jp_tittle_name_wrapper">						<div class="jp_tittle_name">							<h3>Tranding</h3>							<h4>Jobs</h4>						</div>					</div>					<div class="jp_tittle_slider_wrapper">						<div class="jp_tittle_slider_content_wrapper">							<div class="owl-carousel owl-theme">								<div class="item">									<div class="jp_tittle_slides_one">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img1.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>									<div class="jp_tittle_slides_one jp_tittle_slides_two">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img2.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>									<div class="jp_tittle_slides_one jp_tittle_slides_third">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img3.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>								</div>								<div class="item">									<div class="jp_tittle_slides_one">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img2.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>									<div class="jp_tittle_slides_one jp_tittle_slides_two">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img3.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>									<div class="jp_tittle_slides_one jp_tittle_slides_third">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img1.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>								</div>								<div class="item">									<div class="jp_tittle_slides_one">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img3.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>									<div class="jp_tittle_slides_one jp_tittle_slides_two">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img1.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>									<div class="jp_tittle_slides_one jp_tittle_slides_third">										<div class="jp_tittle_side_img_wrapper">											<img src="images/content/tittle_img2.png" alt="tittle_img" />										</div>										<div class="jp_tittle_side_cont_wrapper">											<h4>Graphic Designer (UI / UX)</h4>											<p>Webstrot Pvt. Ltd.</p>										</div>									</div>								</div>							</div>						</div>					</div>				</div>			</div> -->
                                ...
                                <div class="owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="jp_hiring_content_main_wrapper">
                                            <div class="jp_hiring_content_wrapper"> <img src="images/content/hiring_img1.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                            ...
                                            <div class="jp_hiring_content_wrapper hidden-xs"> <img src="images/content/hiring_img1.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                    ...
                                    <div class="item">
                                        <div class="jp_hiring_content_main_wrapper">
                                            <div class="jp_hiring_content_wrapper"> <img src="images/content/hiring_img2.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                            ...
                                            <div class="jp_hiring_content_wrapper hidden-xs"> <img src="images/content/hiring_img2.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                    ...
                                    <div class="item">
                                        <div class="jp_hiring_content_main_wrapper">
                                            <div class="jp_hiring_content_wrapper"> <img src="images/content/hiring_img3.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                            ...
                                            <div class="jp_hiring_content_wrapper hidden-xs"> <img src="images/content/hiring_img3.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                    ...
                                    <div class="item">
                                        <div class="jp_hiring_content_main_wrapper">
                                            <div class="jp_hiring_content_wrapper"> <img src="images/content/hiring_img4.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                            ...
                                            <div class="jp_hiring_content_wrapper hidden-xs"> <img src="images/content/hiring_img4.png" alt="hiring_img" />
                                                <h4>Akshay INC.</h4>
                                                <p>(NewYork)</p>
                                                <ul>
                                                    <li><a href="#">4 Opening</a></li>
                                        ...
                                        <div class="item" data-hash="zero">
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img"> <img src="images/content/job_post_img1.jpg" alt="post_img" /> </div>
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_main_wrapper_cont2">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img"> <img src="images/content/job_post_img2.jpg" alt="post_img" /> </div>
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>HTML Developer (1 - 2 Yrs Exp.)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_main_wrapper_cont2">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img"> <img src="images/content/job_post_img3.jpg" alt="post_img" /> </div>
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>HTML Developer (1 - 2 Yrs Exp.)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_main_wrapper_cont2">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img"> <img src="images/content/job_post_img4.jpg" alt="post_img" /> </div>
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>HTML Developer (1 - 2 Yrs Exp.)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_main_wrapper_cont2">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img"> <img src="images/content/job_post_img5.jpg" alt="post_img" /> </div>
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>HTML Developer (1 - 2 Yrs Exp.)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="jp_add_resume_wrapper">
                                ...
                                <div class="jp_add_resume_cont"> <img src="images/header/animated-logo-wd.gif" alt="logo" />
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="jp_spotlight_main_wrapper">
                                ...
                                <div class="jp_spotlight_slider_wrapper">
                                    <div class="owl-carousel owl-theme">
                                        <div class="item">
                                            <div class="jp_spotlight_slider_img_Wrapper"> <img src="images/content/spotlight_img.jpg" alt="spotlight_img" /> </div>
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="jp_client_slide_show_wrapper">
                                    <div class="jp_client_slider_img_wrapper"> <img src="images/content/client_slider_img.png" alt="client_img" /> </div>
                            ...
                            <div class="item">
                                <div class="jp_client_slide_show_wrapper">
                                    <div class="jp_client_slider_img_wrapper"> <img src="images/content/client_slider_img1.png" alt="client_img" /> </div>
                                    <div class="jp_client_slider_cont_wrapper">
                            ...
                            <div class="item">
                                <div class="jp_client_slide_show_wrapper">
                                    <div class="jp_client_slider_img_wrapper"> <img src="images/content/client_slider_img2.png" alt="client_img" /> </div>
                                    <div class="jp_client_slider_cont_wrapper">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="jp_register_section_main_wrapper">
                <div class="jp_regis_left_side_box_wrapper">
                    <div class="jp_regis_left_side_box"> <img src="images/content/regis_icon.png" alt="icon" />
                ...
                <div class="jp_regis_right_side_box_wrapper">
                    ...
                    <div class="jp_regis_right_side_box"> <img src="images/content/regis_icon2.png" alt="icon" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                    <div class="jp_down_mob_img_wrapper"> <img src="images/content/mobail.png" alt="mobail_img" /> </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 visible-sm visible-xs">
                    <div class="jp_down_mob_img_wrapper"> <img src="images/content/mobail.png" class="img-responsive" alt="mobail_img" /> </div>
                </div>
            </div>
        </div>
    </div> <!-- jp downlord Wrapper End -->
    <script src="js/jquery-2.1.1.js"></script>
    <script src="js/main.js"></script> <?php include("footer.php"); ?>